CREATE DATABASE IF NOT EXISTS TIENDACARTAS;
...
CREATE TABLE IF NOT EXISTS CARTAS_MAGIC(
...
CREATE TABLE IF NOT EXISTS CARTAS_YUGI(
	IDCarta INT(3) ZEROFILL NOT NULL,
...
CREATE TABLE IF NOT EXISTS CARTAS_FOW(
	IDCarta INT(3) ZEROFILL NOT NULL,
